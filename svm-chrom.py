...
##############################################################################
def frequency_normalize (k_values,
                         vector,
                         kmer_list):
...
##############################################################################
def update_sequence_vector (seq_add,
                            seq_rem,
                            vector,
                            discriminant,
                            hyperplane,
...
def make_sequence_vector (sequence,
    ...
    # Normalize it
    (sum_vector_lengths, return_value) = frequency_normalize(k_values,
                                                             sequence_vector,
                                                             kmer_list)
...
for position in xrange(1, len(chromosome) - 49):
  ...
  if ((num_ns == 0) and (unchanged)):
    ...
    (vector, discriminant) = update_sequence_vector\
                             (seq_add,
                              seq_rem,
                              vector,
                              discriminant,
